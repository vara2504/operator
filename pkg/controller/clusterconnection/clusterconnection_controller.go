...
func (r *ReconcileConnection) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if request.Name == ResourceName && request.Namespace == "" {
		...
		managementClusterConnection.Status.Conditions = status.UpdateStatusCondition(managementClusterConnection.Status.Conditions, ts.Status.Conditions, managementClusterConnection.GetGeneration())
